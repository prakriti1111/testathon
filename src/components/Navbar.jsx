  ...
  return (
    ...
    >
      ...
      <div className="text-2xl font-black italic tracking-tighter text-white select-none">
        TESTA<span className="bg-linear-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">THON</span>
      </div>
      ...
      <div className="hidden md:flex items-center gap-8 px-8 py-2 rounded-full bg-white/5 border border-white/10">
        {['about', 'tracks', 'timeline'].map((link) => (
          <a 
            ...
            className="text-[10px] font-bold tracking-[0.2em] uppercase text-gray-400 hover:text-cyan-400 transition-colors "
          >
            {link}
          </a>
        ))}
